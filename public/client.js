let res
  function shorturl() {
	...
	document.getElementById("searchbtn").innerHTML='<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>请稍后...';
    fetch('/api/shorten', {
      method: 'POST',
  ...
  .then(function(myJson) {
    ...
    if(res.key!=="")
    document.getElementById("result").innerHTML='<code>'+window.location.origin+res.key+'</code>';
